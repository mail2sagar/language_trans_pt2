...
enter_text_label = Label(root,text="👇 OUTPUT 👇",bg="lavender blush",font=("Times",10))
enter_text_label.place(relx=0.7,rely=0.3,anchor=CENTER)

sentence = Text(root,height=11,width=30)
sentence.place(relx=0.78,rely=0.5,anchor=CENTER)
